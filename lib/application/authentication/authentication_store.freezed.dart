...
// ignore: unused_element
  Authenticated authenticated(UserEntity user) {
...
mixin _$AuthenticationState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result authenticated(UserEntity user),
    @required Result unauthenticated(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    Result initial(),
    Result authenticated(UserEntity user),
...
class _$AuthenticatedCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(Authenticated(
      user == freezed ? _value.user : user as UserEntity,
    ));
  }
...
abstract class Authenticated implements AuthenticationState {
  const factory Authenticated(UserEntity user) = _$Authenticated;
